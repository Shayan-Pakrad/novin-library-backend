...
namespace Novin.Library.Backend.API.Controllers
{
    ...
    public class BorrowsApiController : BaseApiController<BorrowService, Borrow, BorrowDto, BorrowAddOrUpdateDto>
    {
        public BorrowsApiController(BorrowService service) : base(service)
        {
        }
    }
}